...
<div class="w3-container"><img src="map/df.png" heigth="200px" width="200px"></div>
...
WHERE UF_PROPONENTE LIKE 'DF' order by NM_MUNICIPIO_PROPONENTE
";
