...
<canvas class="w3-half" id="rocha" width="1000px" height="1000px"><canvas><script src="http://xn--programaogrfica-xjb4a5e.com.br/infoAgora/rocha.js"></script>
</div>
...
<br>
    ...
    <footer class="w3-container w3-padding-16 w3-light-grey">
      <h4>FOOTER</h4>
      <p><a href="/w3css">Brasil Transparente</a></p>
    </footer>
