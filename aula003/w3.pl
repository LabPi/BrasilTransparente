...
.w3-top,.w3-bottom{position:fixed;padding-left: 10px;;width:100%;z-index:1}.w3-top{top:0}.w3-bottom{bottom:0}
...
.w3-row-padding,.w3-row-padding>.w3-half,.w3-row-padding>.w3-third,.w3-row-padding>.w3-twothird,.w3-row-padding>.w3-quarter,.w3-row-padding>.w3-col{padding: 1.7em 8px}
